    ...
    <div class="div1">
        ...
        <div class="row-flex">
            ...
            <div class="button-areas">
                ...
                <div class="top-button hidden">
                    <div class="">
                        <router-link to="/tags/view">Edit Filters</router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class='search input-group' id="t">
                ...
                <span class="input-group-label" id="dark">
                    <router-link to="/tags/view" id="white">Edit Filters</router-link>
                </span>
